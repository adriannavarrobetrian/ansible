...
cp -v tomcat/cms/WEB-INF/classes/cms-configuration/globalcollect/globalcollect.profile.sandbox.properties /tomcat/cms/WEB-INF/classes/cms-configuration/globalcollect/globalcollect.profile.sandbox.properties
...
cp -v tomcat/engine/WEB-INF/classes/engine-configuration/globalcollect/globalcollect.profile.sandbox.properties /tomcat/engine/WEB-INF/classes/engine-configuration/globalcollect/globalcollect.profile.sandbox.properties
...
cp -v tomcat/engine/WEB-INF/classes/engine-configuration/fetch/fetch.profile.production.properties /tomcat/engine/WEB-INF/classes/engine-configuration/fetch/fetch.profile.production.properties
echo
...
#cp -v tomcat/gbase/WEB-INF/classes/gbase-configuration/app/gbase.deploy.properties /tomcat/gbase/WEB-INF/classes/gbase-configuration/app/gbase.deploy.properties
#cp -v tomcat/gbase/WEB-INF/classes/gbase-configuration/app/googlebase.profile.dummy.properties /tomcat/gbase/WEB-INF/classes/gbase-configuration/app/googlebase.profile.dummy.properties
...
echo "--- EXTRAS -- Only for Sandbox ---"
cp -v tomcat/gbase/WEB-INF/classes/gbase-configuration/configuration-env.xml /tomcat/gbase/WEB-INF/classes/gbase-configuration/configuration-env.xml
echo

#echo "--- LOGS ---"
#cp -v tomcat/admin/WEB-INF/classes/admin-configuration/app/log4j.admin.sandbox.properties /tomcat/admin/WEB-INF/classes/admin-configuration/app/log4j.admin.sandbox.properties
#cp -v tomcat/api/WEB-INF/classes/api-configuration/app/log4j.api.sandbox.properties /tomcat/api/WEB-INF/classes/api-configuration/app/log4j.api.sandbox.properties
#cp -v tomcat/cms/WEB-INF/classes/cms-configuration/app/log4j.cms.sandbox.properties /tomcat/cms/WEB-INF/classes/cms-configuration/app/log4j.cms.sandbox.properties
#cp -v tomcat/engine/WEB-INF/classes/engine-configuration/app/log4j.engine.sandbox.properties /tomcat/engine/WEB-INF/classes/engine-configuration/app/log4j.engine.sandbox.properties
#cp -v tomcat/file/WEB-INF/classes/file-configuration/app/log4j.file.sandbox.properties /tomcat/file/WEB-INF/classes/file-configuration/app/log4j.file.sandbox.properties
#cp -v tomcat/gbase/WEB-INF/classes/gbase-configuration/app/log4j.gbase.sandbox.properties /tomcat/gbase/WEB-INF/classes/gbase-configuration/app/log4j.gbase.sandbox.properties
#cp -v tomcat/template/WEB-INF/classes/template-configuration/app/log4j.template.sandbox.properties /tomcat/template/WEB-INF/classes/template-configuration/app/log4j.template.sandbox.properties
#echo
